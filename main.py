...
from sqlalchemy import Integer, String, Text, ForeignKey, exists
...
@app.route('/')
def get_all_posts():
    if not db.session.query(exists().where(User.email == 'admin@gmail.com')).scalar():
        new_user = User(
            name='admin',
...
def show_post(post_id):
    ...
    #comments_post = db.get_or_404(Comment, post_id)
